...
Very recently, from RHIC STAR experiment's W-boson spin asymmetry measurements~\cite{Adamczyk:2014xyw}, as shown in Fig~\ref{fig:STAR_W}, the data strongly favor a positively polarized sea up-quark.  Indeed, when include the STAR W data,  NLO global fit DSSV~\cite{DSSV2008} favors a positive anti-up quark polarization and a negative anti-down quark polarization, as shown in Fig.~\ref{fig:STAR_WDSSV}.
